...
def index():
    ...
    paper_info = search_paper_by_author(author_name)
    return render_template('index.html', author_name=author_name, paper_info = paper_info)
